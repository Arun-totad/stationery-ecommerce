          ...
          {!currentView && (
            <>
              ...
              <div className="mb-10 rounded-2xl bg-white p-6 shadow">
                <h3 className="mb-4 text-lg font-semibold text-yellow-900">Recent Orders</h3>
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="px-6 py-4 text-left text-sm font-semibold tracking-wider text-gray-700 uppercase">
                          Order Number
                        </th>
                        <th className="px-6 py-4 text-left text-sm font-semibold tracking-wider text-gray-700 uppercase">
                          Customer
                    ...
                    <tbody className="divide-y divide-gray-200 bg-white">
                      {orders.slice(0, 5).map((order) => (
                        <tr key={order.id} className="hover:bg-gray-100">
                          <td className="px-6 py-3 text-base font-medium whitespace-nowrap text-blue-700">
                            {order.orderNumber ||
                              (order.id
